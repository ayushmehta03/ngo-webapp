  ...
  return (
    <>
      <div className="flex flex-col space-y-4 items-center mb-10 px-4">
        <h1 className="text-2xl sm:text-3xl font-bold text-black dark:text-gray-300 text-center">
          Wanna Make a Change?
        </h1>
        <p className="text-base sm:text-xl leading-relaxed text-center max-w-3xl mx-auto text-black dark:text-gray-300">
        ...
        <h2 className="text-xl sm:text-2xl text-black dark:text-red-400 text-center">
          Join Us in Creating a Better Tomorrow{" "}
          <BicepsFlexed className="inline ml-2" size={28} />
        </h2>
      </div>

      <div className="flex flex-col space-y-4 items-center text-center px-4">
        <h3 className="text-lg sm:text-xl text-black dark:text-green-600">

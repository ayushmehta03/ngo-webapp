    ...
    <>
      <div className="px-4 sm:px-10 max-w-4xl mx-auto mt-8">
        ...
        <p className="mt-6 text-center text-base sm:text-lg text-gray-800 dark:text-gray-300 leading-7 sm:leading-8">
          Our NGO also operates a secure and affordable Paying Guest facility
          dedicated to girls and working women. Nestled in a peaceful
          environment, the PG offers comfortable accommodation, nutritious
          meals, and a nurturing community. We emphasize safety, hygiene, and
          empowerment—making it the perfect space for women to live, learn, and
          grow with dignity.
        </p>
      </div>

      <div className="flex items-center justify-center gap-2 mt-10">
        <h2 className="text-xl text-green-800 dark:text-green-600 font-semibold">
          Our Services
        </h2>
        <HelpingHand className="text-pink-500" />
      </div>

      <section className="mt-10 px-4 sm:px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {[
          {
            icon: <Lightbulb className="text-yellow-600 dark:text-yellow-500" />,
            label: "24 Hours Light",
          },
          {
            icon: <WifiCog className="text-green-600 dark:text-green-400" />,
            label: "Fast Wifi",
          },
          {
            icon: (
              <BrushCleaning className="text-red-600 dark:text-red-300" />
            ),
            label: "Daily Sweeping",
          },
          {
            icon: <CctvIcon className="text-blue-700 dark:text-blue-500" />,
            label: "24x7 CCTV",
          },
        ].map((item, i) => (
          <div
      ...
      <section className="mt-10 px-4 sm:px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {[
          {
            title: "Single Seater",
            type: "Single",
      ...
      <section className="flex justify-center mt-12">
        <div className="w-full max-w-[360px] p-4 rounded-2xl border-2">
          <div className="flex gap-3 items-center p-2">
            <h2 className="text-xl font-semibold text-blue-700 dark:text-blue-500">
              Enquiry Form
            </h2>
          ...
          >
            {[
              ...
              { label: "Enter your email id", name: "email", type: "email" },
              {
              ...
              <div
                className="flex flex-col justify-center gap-2 p-2 w-full"
                key={idx}
              >
                <Label>{input.label}</Label>
                <Input required type={input.type} name={input.name} />
              </div>
            ))}
      ...
      <section className="mt-12 flex flex-wrap justify-center items-center gap-4 px-4 text-center">
        ...
        <div className="flex gap-2 justify-center items-center">
          ...
          <p className="break-words">creswopurnia@gmail.com</p>
        </div>
      </section>

      <section className="mt-12 flex flex-col sm:flex-row justify-center items-center text-center gap-2 px-4">
        <MapIcon className="text-blue-500" />
        <div>
          <p>Near Bright Career School,</p>
